...
void Profile::ApplyProfile(HKEY const& key) const
{
	...
	SetValue(key, L"UserSettingColorSaturationMatrix", UserSettingColorSaturationMatrix);
	SetValue(key, L"UserSettingColorSaturationPA", UserSettingColorSaturationPA);
...
Profile Profile::GetNightLightProfile(double NightLightValue)
{
	...
	double temperature = 31 - (((6500 - NightLightValue) / 74.05));
	...
	//if (NightLightValue < 2200)
	//{
	//	//we need to go to red zone
	//}
	//else
	//{
