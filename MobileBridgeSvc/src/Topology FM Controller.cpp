...
HRESULT FmController::Initialize()
{
    CComPtr<IMMDeviceEnumerator> spEnumerator;
    CComPtr<IMMDeviceCollection> spMMDeviceCollection;
    UINT deviceCount = 0;
    BOOL fFmRxEndpointFound = FALSE;
...
CComPtr<IMMDevice> FmController::GetMMDevice()
{
    return m_MMDevice;
}

// Sets fm volume. This is a property on topology filter.
HRESULT FmController::SetFmVolume(_In_ float volume)
{
	LONG properVolume;
    HRESULT hr = S_OK;
